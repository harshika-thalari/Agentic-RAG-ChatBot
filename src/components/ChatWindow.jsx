      ...
      <div className="chat-window" ref={chatWindowRef}>
        {messages.map((msg) => (
          ...
          >
            ...
            {/* Show a simple loading indicator for streaming messages */}
            {msg.isStreaming ? <div className="typing-indicator"><span></span><span></span><span></span></div> : msg.text}
            
            {/* Show actions only for non-streaming AI messages on hover */}
            {msg.from === 'ai' && !msg.isStreaming && (hoveredMessageId === msg.id || modifyMenuOpen === msg.id) && (
              <div className="message-actions-new">
                <div className="action-row">
                  <div className="action-group">
                  ...
                  <div className="action-group">
                    ...
                    <div className="action-menu">
                      <button className="action-icon-new" onClick={() => setModifyMenuOpen(modifyMenuOpen === msg.id ? null : msg.id)}>
